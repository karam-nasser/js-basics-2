...
updateStatus(newStatus) {
    ...
    console.log('The order for customer ' +customerId+ ' is now '+this.string);
}
...
const foodOrdered = ["biryani", "Naan", "Mango Lassi"];
const orderedAt = "3:00 PM";
const customerId = 575;
const firstTicket = new Ticket (foodOrdered, orderedAt, customerId);
